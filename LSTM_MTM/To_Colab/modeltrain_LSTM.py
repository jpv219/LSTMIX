# -*- coding: utf-8 -*-
"""modeltrain_LSTM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tWvX3Yn9x5nvdkL-mwPExsmrg-4NjHE3

# LSTM windowing and model training<br>
...
fig_savepath = '/content/fuyue_data/figs/'
input_savepath = '/content/fuyue_data/input_data/'
trainedmod_savepath = '/content/fuyue_data/trained_svmodels/'
tuningmod_savepath = '/content/fuyue_data/Hypertuning/'
        ...
        for epoch in range(num_epochs): #looping through epochs
            ...
            with torch.no_grad():  # Predictions performed with no gradient calculations
                ...
                if batch_loss:
                    ...
                    for traindata in trainloader:
                        ...
                        #X_trbatch, y_trbatch = X_trbatch.to(device), y_trbatch.to(device)
                    ...
                    for valdata in valloader:
                        ...
                        #X_valbatch, y_valbatch = X_valbatch.to(device), y_valbatch.to(device)
            ...
            if tuning:
                with tempfile.TemporaryDirectory() as checkpoint_dir:
                    ...
                    train.report({"val_loss": float(v_rmse), "train_loss": float(t_rmse)}, checkpoint=checkpoint)
...
def main():
    ...
    hidden_size = 512  # Number of hidden units in the LSTM cell, determines how many weights will be used in the hidden state calculations
    ...
    batch_size = 40 # How many windows are being processed per pass through the LSTM
    learning_rate = 0.002
    num_epochs = 5000
    check_epochs = 100
    tf_ratio = 0.1
