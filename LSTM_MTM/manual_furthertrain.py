...
def further_train(model_choice, init_training, X_tens, y_tens, best_trial_config,best_chkpt_path):
    
    config_training = best_trial_config
...
def main():
    ...
    with open(f'{best_model_path}/config_{model_choice}.pkl', 'wb') as pickle_file:
        ...
        pickle.dump(best_trial_config, pickle_file)
    ...
    if train_further.lower() == 'y':
        ...
        further_train(model_choice,init_training,X_tens,y_tens,best_trial_config,best_chkpoint_path)
